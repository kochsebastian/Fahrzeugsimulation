...
writes interfaces.failure_detected, interfaces.delta_sfl, interfaces.delta_sfr, interfaces.delta_srr, interfaces.delta_srl, interfaces.sfl, interfaces.srl, interfaces.srr, interfaces.sfr
reads interfaces.vfr, interfaces.vfl, interfaces.vrr, interfaces.vrl {
	...
	public void calc() {
		...
		interfaces.sfl = sfl; // Main/calc 18
		interfaces.srl = srl; // Main/calc 19
		interfaces.srr = srr; // Main/calc 20
		interfaces.sfr = sfr; // Main/calc 21
	}
}