...
namespace {
	// test fixture class
	class components_Test_SOS_state_checkAllStatelocationsActiveContinuesNot_Automatic_SubClass: public ::testing::Test {
		// TODO
	};

	TEST_F(components_Test_SOS_state_checkAllStatelocationsActiveContinuesNot_Automatic_SubClass, components_Test_SOS_state_checkAllStatelocationsActiveContinuesNot_Automatic_checkAllStatelocationsActiveContinuesNot) {
