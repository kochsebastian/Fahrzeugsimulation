...
static void initClass_ROOT_AscetTireSimApp(ROOT_AscetTireSimApp_Class *self)
{
    self->ASCET_TOP_Ptr = (struct L1_AscetTireSimApp_Obj*) initInstance_L1_AscetTireSimApp();
}
...
static ASDClassHeader ROOT_ClassHeader_AscetTireSimApp = {0, 0, 0, 1, (MethodList *)0, (MethodList *)0};
static ROOT_AscetTireSimApp_Class ROOT_AscetTireSimApp_ClassObj = {{1, {&ROOT_ClassHeader_AscetTireSimApp}, {0}}};

/**
 * Initialization of model 
 **/

ASDObject *initializeRoot_AscetTireSimApp(void)
{
    struct ROOT_AscetTireSimApp_Obj *self = 0;

    initClass_ROOT_AscetTireSimApp(&ROOT_AscetTireSimApp_ClassObj);
    CREATE_OBJECT(self, ROOT_AscetTireSimApp);
...
{
    return initializeRoot_AscetTireSimApp();
}
