...
static void initClass_ROOT_TireSimulation_PC(ROOT_TireSimulation_PC_Class *self)
{
    self->ASCET_TOP_Ptr = (struct L1_TireSimulation_PC_Obj*) initInstance_L1_TireSimulation_PC();
}
...
static ASDClassHeader ROOT_ClassHeader_TireSimulation_PC = {0, 0, 0, 1, (MethodList *)0, (MethodList *)0};
static ROOT_TireSimulation_PC_Class ROOT_TireSimulation_PC_ClassObj = {{1, {&ROOT_ClassHeader_TireSimulation_PC}, {0}}};

/**
 * Initialization of model 
 **/

ASDObject *initializeRoot_TireSimulation_PC(void)
{
    struct ROOT_TireSimulation_PC_Obj *self = 0;

    initClass_ROOT_TireSimulation_PC(&ROOT_TireSimulation_PC_ClassObj);
    CREATE_OBJECT(self, ROOT_TireSimulation_PC);
...
{
    return initializeRoot_TireSimulation_PC();
}
